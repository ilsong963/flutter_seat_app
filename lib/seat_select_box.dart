  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: Column(
        ...
        children: [
          Text('Screen', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          SizedBox(height: 10),
          row(1),
          SizedBox(height: 10),
          row(2),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [seatInfo('Available', Colors.grey), SizedBox(width: 4), seatInfo('Selected', Colors.amber)],
          ),
        ],
      ),
    );
